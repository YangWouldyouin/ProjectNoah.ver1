...
public class DialogManager : MonoBehaviour
{
    ...
    void GenerateData()
    {
        ...
        talkData.Add(1008, new string[] { "조종실 문이 열렸습니다.", "업무 공간으로 향하십시오." });
        ...
        talkData.Add(1009, new string[] { "생체 체크 기계가 수리 및 연동 되었습니다.", "이제 해당 기계를 통해", "노아 n.113 의 생체 데이터를 체크할 수 있습니다.", "노아 n.113의 건강 상태를 주시하십시오." });
    ...
    IEnumerator PrintAIDialog(int DialogNum)
    {
        ...
        {
            for (int i = 0; i < talkData[num].Length; i++)
            {
