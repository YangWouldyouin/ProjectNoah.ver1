...
public class PuzzleListUIManager : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (GameManager.gameManager._savePageData.IsPlanetSelectMission0)
        {
        ...
        if (GameManager.gameManager._savePageData.IsFakePlanetSelectMission0)
        { 
