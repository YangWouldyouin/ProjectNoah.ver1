...
pushButton, NoCenterButton, smashButton, observeButton;
    ...
    public ObjectData AstronautPictureData_2_W;
    ...
    void Start()
    {
        ...
        observeButton = AstronautPicture_2_W.CenterButton1;
        observeButton.onClick.AddListener(OnObserve);

        NoCenterButton = AstronautPicture_2_W.CenterButton1; // 비활성화 버튼
    }
    void DiableButton()
    {
    ...
    void Update()
    {
        if (AstronautPictureData_2_W == false)
        {
            AstronautPicture_2_Image_W.SetActive(false);
        }
    }
    ...
    public void OnObserve()
    {
        ...
        AstronautPicture_2_Image_W.SetActive(true); // UI로 사진이미지 크게 보여주기
    ...
    IEnumerator TurnOffPicture()
    {
        ...
        AstronautPicture_2_Image_W.SetActive(false); // UI로 사진이미지 크게 보여주기
    }
