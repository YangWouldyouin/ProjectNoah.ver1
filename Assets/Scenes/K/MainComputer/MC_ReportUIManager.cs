...
public class MC_ReportUIManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        /* 내용 */
        Detail_Rep[0] = "이번 탐사를 통해 발견한 신 약품에 대해 추가 연구를 진행해야 한다. 해당 약품을 실험 개체에 투약하자, 동일한 성장 조건에서 약 5배 향상된 성장 속도를 보였기 때문이다.\n이 발견은 순전히 실수에서 탄생했다. 신 약품의 색상은 노란색으로, 기존 투약하던 영양제와 같은 색상이다. 계속되는 철야에 두 약품을 제대로 구분하지 못하고 신 약품을 실수로 투약하고 만 것이다.\n긍정적인 결과가 나와서 다행이다. 아니었다면 트렐러니가 나를 거세게 질책했을 것이다.";
